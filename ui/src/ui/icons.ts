...
// Shared lobster logo SVG — used in sidebar and titlebar.
// Pass a unique gradientId per render location to avoid duplicate SVG defs IDs.
export function renderLobsterLogo(gradientId = "lobster-grad", svgClass?: string): TemplateResult {
  return html`
    <svg
      class=${svgClass ?? nothing}
      viewBox="0 0 120 120"
      fill="none"
